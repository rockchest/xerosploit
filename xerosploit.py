/* hello forks this is rock chest i saw that this xerosploit script is very old and can only run in python2 before, but now i have modified this script and now this script can run in python3 */
