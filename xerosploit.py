/* hello guys this is rock i made some changes in xerosploit.py because it only runs in python2 environment, but now it can be launched in python3 environment (only in debian).
